...
export enum QUERY_KEYS {
	API_GET_CUSTOMER_PROFILE = 'API_GET_CUSTOMER_PROFILE',
	API_GET_PRODUCTS = 'API_GET_PRODUCTS',
	API_GET_LOCALIZED_PRODUCT = 'API_GET_LOCALIZED_PRODUCT',
	API_GET_LOCALIZED_PRODUCTS = 'API_GET_LOCALIZED_PRODUCTS',
	API_GET_LOCALIZED_CATEGORIES = 'API_GET_LOCALIZED_CATEGORIES',
	API_GET_PRODUCT_REVIEWS = 'API_GET_PRODUCT_REVIEWS',
	API_GET_SHIPPING_OPTIONS = 'API_GET_SHIPPING_OPTIONS'
}
